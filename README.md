...
This is a custom [Homebrew](https://brew.sh/) tap repository for [@nelsonlaidev](https://github.com/nelsonlaidev) software packages.
...
| -------------------------------------------------- | --------------------------------------- | ------- | ------------------------------- |
| [scoutly](https://github.com/nelsonlaidev/scoutly) | [scoutly](./Casks/scoutly.rb)           | Stable  | Fast website auditing CLI       |
